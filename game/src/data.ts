...
export const BUSINESS: Record<LicenseKey, BusinessConfig> = {
  aquaworks: {
    name: "Tideglass AquaWorks", sector: "Water utility", stage: "Infrastructure", islandAffinity: "Tideglass", icon: "≈", color: "#4eaeb7", model: "./assets/businesses-v2/01_aquaworks_solarpunk_v2.glb",
  ...
  sungrid: {
    name: "Sunwell Microgrid", sector: "Energy utility", stage: "Infrastructure", islandAffinity: "Sunwell", icon: "☀", color: "#dda942", model: "./assets/businesses-v2/02_sunwell_microgrid_solarpunk_v2.glb",
  ...
  greenhouse: {
    name: "Greenloom Greenhouse", sector: "Food and bio-production", stage: "Primary", islandAffinity: "Greenloom", icon: "♧", color: "#70a958", model: "./assets/businesses-v2/03_greenloom_greenhouse_solarpunk_v2.glb",
  ...
  mine: {
    name: "Stonewake Mine", sector: "Mineral extraction", stage: "Primary", islandAffinity: "Stonewake", icon: "◆", color: "#8d806d", model: "./assets/businesses-v2/04_stonewake_mine_solarpunk_v2.glb",
  ...
  timberworks: {
    name: "Timbercoast Works", sector: "Regenerative forestry", stage: "Primary", islandAffinity: "Greenloom", icon: "▤", color: "#9a754d", model: "./assets/businesses-v2/05_timbercoast_works_solarpunk_v2.glb",
  ...
  cratemill: {
    name: "Freight Crate Mill", sector: "Packaging", stage: "Manufacturing", islandAffinity: "Copper Quay", icon: "▣", color: "#c88a50", model: "./assets/businesses-v2/06_freight_crate_mill_solarpunk_v2.glb",
  ...
  workshop: {
    name: "Maker Workshop", sector: "Component manufacturing", stage: "Manufacturing", islandAffinity: "Kilnrise", icon: "M", color: "#df8465", model: "./assets/businesses-v2/07_maker_workshop_solarpunk_v2.glb",
  ...
  factory: {
    name: "Sunwoven Factory", sector: "Capital equipment", stage: "Manufacturing", islandAffinity: "Kilnrise", icon: "F", color: "#cc7652", model: "./assets/businesses-v2/08_sunwoven_factory_solarpunk_v2.glb",
  ...
  construction: {
    name: "Civic Construction Co.", sector: "Building systems", stage: "Manufacturing", islandAffinity: "Hearthmarket", icon: "▦", color: "#b46f4f", model: "./assets/businesses-v2/09_civic_construction_solarpunk_v2.glb",
  ...
  freight: {
    name: "Copper Quay Freight", sector: "Logistics service", stage: "Commerce", islandAffinity: "Copper Quay", icon: "↔", color: "#b68758", model: "./assets/businesses-v2/10_copper_quay_freight_solarpunk_v2.glb",
  ...
  shop: {
    name: "Supply Shop & Café", sector: "Retail production", stage: "Commerce", islandAffinity: "Lantern Row", icon: "S", color: "#b886c6", model: "./assets/businesses-v2/11_supply_shop_cafe_solarpunk_v2.glb",
  ...
  restaurant: {
    name: "Sunset Market Kitchen", sector: "Hospitality service", stage: "Services", islandAffinity: "Lantern Row", icon: "R", color: "#d47d5b", model: "./assets/businesses-v2/12_sunset_market_kitchen_solarpunk_v2.glb",
  ...
  gym: {
    name: "Harbor Gym", sector: "Wellness service", stage: "Services", islandAffinity: "Pulsegrove", icon: "H", color: "#4d9487", model: "./assets/businesses-v2/13_harbor_gym_solarpunk_v2.glb",
  ...
  cinema: {
    name: "Lantern Cinema", sector: "Entertainment service", stage: "Services", islandAffinity: "Lantern Row", icon: "C", color: "#d39a45", model: "./assets/businesses-v2/14_lantern_cinema_solarpunk_v2.glb",
  ...
  recycler: {
    name: "Tideglass Reclamation Hub", sector: "Resource recovery", stage: "Circular", islandAffinity: "Tideglass", icon: "♻", color: "#718c62", model: "./assets/businesses-v2/15_tideglass_recycler_solarpunk_v2.glb",
